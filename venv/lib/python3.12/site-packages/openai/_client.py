...
class OpenAI(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        if api_key is None:
            raise OpenAIError(
                "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"
            )
